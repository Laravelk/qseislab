...
float SeismTrace::getPWaveArrival() const
{
    return _pWaveArrival;
}
...
float SeismTrace::getSWaveArrival() const
{
    return _sWaveArrival;
}
...
float SeismTrace::getMaxValue() const
{
    return _maxValue;
}
